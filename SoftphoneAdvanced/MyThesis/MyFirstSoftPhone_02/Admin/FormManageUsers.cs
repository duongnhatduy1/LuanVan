    ...
    public partial class FormManageUsers : Form
    {
        ...
        async System.Threading.Tasks.Task RunAsyncGetUserByAdmin()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                // Gọi API
                var response = client.GetAsync($"http://{Global.ServerInfo}/api/admin/account").Result;
        ...
        public FormManageUsers(FormMainAdmin f)
        {
            InitializeComponent();
            InitUsers();
            formMainAdmin = f;
        ...
        public void InitUsers()
        {
            ...
            foreach (var u in _UserOnlines)
            {
                ...
                if (u.Role_Name != "Banned")
                    ...
                    label.Font = new System.Drawing.Font("Microsoft Sans Serif", 20.25F, System.Drawing.FontStyle.Strikeout, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        ...
        private void Delete_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dialogResult = MessageBox.Show($"Bạn có chắc xóa username {tempUsername} không?", "Xóa người dùng", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
        ...
        private void Update_Click(object sender, EventArgs e)
        {
            ...
            if (updateUser == null)
            {
                if (u != null)
                {
                    updateUser = new FormAddUser(u, "update", formMainAdmin);
